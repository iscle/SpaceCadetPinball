...
TRollover::TRollover(TPinballTable *table, int groupIndex) : TCollisionComponent(table, groupIndex,
                                                                                 false) {
    if (ListBitmap)
...
void
TRollover::Collision(TBall *ball, vector_type *nextPosition, vector_type *direction, float coef,
                     TEdgeSegment *edge) {
