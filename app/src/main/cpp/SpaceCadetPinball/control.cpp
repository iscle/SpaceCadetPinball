...
component_info control::score_components[88]
        {
                ...
                component_info{&control_roll3_tag,
                               {ReentryLanesRolloverControl, 1, control_roll_scores1}},
                component_info{&control_roll2_tag,
                               {ReentryLanesRolloverControl, 1, control_roll_scores1}},
                component_info{&control_roll1_tag,
                               {ReentryLanesRolloverControl, 1, control_roll_scores1}},
                ...
                component_info{&control_roll112_tag,
                               {LaunchLanesRolloverControl, 1, control_roll_scores2}},
                component_info{&control_roll111_tag,
                               {LaunchLanesRolloverControl, 1, control_roll_scores2}},
                component_info{&control_roll110_tag,
                               {LaunchLanesRolloverControl, 1, control_roll_scores2}},
                component_info{&control_launch_bump_tag, {BumperGroupControl, 0, nullptr}},
                component_info{&control_rebo1_tag,
                               {FlipperRebounderControl1, 1, control_rebo_score1}},
                component_info{&control_rebo2_tag,
                               {FlipperRebounderControl2, 1, control_rebo_score1}},
                ...
                component_info{&control_oneway4_tag, {DeploymentChuteToEscapeChuteOneWayControl, 6,
                                                      control_oneway4_score1}},
                component_info{&control_oneway10_tag,
                               {DeploymentChuteToTableOneWayControl, 0, nullptr}},
                ...
                component_info{&control_roll4_tag,
                               {OutLaneRolloverControl, 1, control_roll_score1}},
                component_info{&control_roll8_tag,
                               {OutLaneRolloverControl, 1, control_roll_score1}},
                component_info{&control_lite17_tag, {ExtraBallLightControl, 0, nullptr}},
                component_info{&control_roll6_tag,
                               {ReturnLaneRolloverControl, 2, control_roll_score2}},
                component_info{&control_roll7_tag,
                               {ReturnLaneRolloverControl, 2, control_roll_score2}},
                component_info{&control_roll5_tag,
                               {BonusLaneRolloverControl, 1, control_roll_score3}},
                component_info{&control_roll179_tag,
                               {FuelRollover1Control, 1, control_roll_score4}},
                component_info{&control_roll180_tag,
                               {FuelRollover2Control, 1, control_roll_score4}},
                component_info{&control_roll181_tag,
                               {FuelRollover3Control, 1, control_roll_score4}},
                component_info{&control_roll182_tag,
                               {FuelRollover4Control, 1, control_roll_score4}},
                component_info{&control_roll183_tag,
                               {FuelRollover5Control, 1, control_roll_score4}},
                component_info{&control_roll184_tag,
                               {FuelRollover6Control, 1, control_roll_score4}},
                component_info{&control_flag1_tag, {FlagControl, 2, control_flag_score1}},
                component_info{&control_kickout2_tag,
                               {HyperspaceKickOutControl, 5, control_kickout_score1}},
                component_info{&control_hyper_lights_tag,
                               {HyperspaceLightGroupControl, 0, nullptr}},
                ...
                component_info{&control_target1_tag,
                               {BoosterTargetControl, 2, control_target_score1}},
                component_info{&control_target2_tag,
                               {BoosterTargetControl, 2, control_target_score1}},
                component_info{&control_target3_tag,
                               {BoosterTargetControl, 2, control_target_score1}},
                ...
                component_info{&control_target6_tag,
                               {MedalTargetControl, 3, control_target_score2}},
                component_info{&control_target5_tag,
                               {MedalTargetControl, 3, control_target_score2}},
                component_info{&control_target4_tag,
                               {MedalTargetControl, 3, control_target_score2}},
                component_info{&control_bumber_target_lights_tag,
                               {MedalLightGroupControl, 0, nullptr}},
                component_info{&control_target9_tag,
                               {MultiplierTargetControl, 2, control_target_score3}},
                component_info{&control_target8_tag,
                               {MultiplierTargetControl, 2, control_target_score3}},
                component_info{&control_target7_tag,
                               {MultiplierTargetControl, 2, control_target_score3}},
                component_info{&control_top_target_lights_tag,
                               {MultiplierLightGroupControl, 0, nullptr}},
                component_info{&control_target10_tag,
                               {FuelSpotTargetControl, 1, control_target_score4}},
                component_info{&control_target11_tag,
                               {FuelSpotTargetControl, 1, control_target_score4}},
                component_info{&control_target12_tag,
                               {FuelSpotTargetControl, 1, control_target_score4}},
                component_info{&control_target13_tag,
                               {MissionSpotTargetControl, 1, control_target_score5}},
                component_info{&control_target14_tag,
                               {MissionSpotTargetControl, 1, control_target_score5}},
                component_info{&control_target15_tag,
                               {MissionSpotTargetControl, 1, control_target_score5}},
                component_info{&control_target16_tag,
                               {LeftHazardSpotTargetControl, 1, control_target_score6}},
                component_info{&control_target17_tag,
                               {LeftHazardSpotTargetControl, 1, control_target_score6}},
                component_info{&control_target18_tag,
                               {LeftHazardSpotTargetControl, 1, control_target_score6}},
                component_info{&control_target19_tag,
                               {RightHazardSpotTargetControl, 1, control_target_score6}},
                component_info{&control_target20_tag,
                               {RightHazardSpotTargetControl, 1, control_target_score6}},
                component_info{&control_target21_tag,
                               {RightHazardSpotTargetControl, 1, control_target_score6}},
                component_info{&control_target22_tag,
                               {WormHoleDestinationControl, 1, control_target_score7}},
                component_info{&control_roll9_tag,
                               {SpaceWarpRolloverControl, 1, control_roll_score5}},
                component_info{&control_kickout3_tag,
                               {BlackHoleKickoutControl, 1, control_kickout_score2}},
                component_info{&control_kickout1_tag,
                               {GravityWellKickoutControl, 1, control_kickout_score3}},
...
int control::MissionRcArray[17] = {60, 61, 62, 63, 64, 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75,
                                   76};
...
void control::ReentryLanesRolloverControl(int code, TPinballComponent *caller) {
    if (code == 63) {
        if (!light_on(&control_lite56_tag) &&
            control_l_trek_lights_tag.Component->Message(39, 0.0)) {
            control_l_trek_lights_tag.Component->Message(34, 0.0);
            control_l_trek_lights_tag.Component->Message(20, 0.0);
            control_r_trek_lights_tag.Component->Message(34, 0.0);
            control_r_trek_lights_tag.Component->Message(20, 0.0);
            ...
            if (light->BmpIndex1) {
                ...
                if (activeCount == control_bmpr_inc_lights_tag.Component->Message(38, 0.0)) {
                    ...
                    if (control_bump1_tag.Component->BmpIndex < 3) {
                        ...
                        control_info_text_box_tag.Component->Display(pinball::get_rc_string(5, 0),
                                                                     2.0);
                    }
            ...
            if (light->BmpIndex1) {
                ...
                if (msg1 == control_ramp_bmpr_inc_lights_tag.Component->Message(38, 0.0)) {
                    ...
                    if (control_bump5_tag.Component->BmpIndex < 3) {
                        ...
                        control_info_text_box_tag.Component->Display(pinball::get_rc_string(6, 0),
                                                                     2.0);
                    }
...
void control::WormHoleControl(int code, TPinballComponent *caller) {
    ...
    if (code == 63) {
        ...
        if (lite4Msg) {
            ...
            if (lite4Msg == sinkFlag + 1) {
                if (TableG->MultiballFlag) {
                    ...
                    control_info_text_box_tag.Component->Display(pinball::get_rc_string(49, 0),
                                                                 2.0);
                    ...
                    wormhole_tag_array3[sinkFlag]->GetComponent()->Message(11,
                                                                           static_cast<float>(2 -
                                                                                              sinkFlag));
        ...
        wormhole_tag_array3[sinkFlag2]->GetComponent()->Message(11,
                                                                static_cast<float>(2 - sinkFlag2));
    ...
    switch (code) {
        case 47:
            if (control_fuel_bargraph_tag.Component == caller && lite198Msg > 1) {
                ...
                control_r_trek_lights_tag.Component->Message(34, 0.0);
                control_r_trek_lights_tag.Component->Message(20, 0.0);
                control_mission_text_box_tag.Component->Display(pinball::get_rc_string(109, 0),
                                                                4.0);
        ...
        case 60:
            if (control_fuel_bargraph_tag.Component == caller && lite198Msg) {
                if (control_fuel_bargraph_tag.Component->Message(37, 0.0) == 1) {
                    control_mission_text_box_tag.Component->Display(pinball::get_rc_string(116, 0),
                                                                    4.0);
                }
                break;
            }
...
void control::BugHuntController(int code, TPinballComponent *caller) {
    ...
    if (code != 63) {
        ...
        snprintf(Buffer, sizeof Buffer, pinball::get_rc_string(125, 0),
                 control_lite56_tag.Component->MessageField);
        control_mission_text_box_tag.Component->Display(Buffer, -1.0);
        return;
    }
...
void control::CosmicPlagueController(int code, TPinballComponent *caller) {
    ...
    if (code != 63) {
        ...
        snprintf(Buffer, sizeof Buffer, pinball::get_rc_string(139, 0),
                 control_lite56_tag.Component->MessageField);
        control_mission_text_box_tag.Component->Display(Buffer, -1.0);
        return;
    }
...
void control::DoomsdayMachineController(int code, TPinballComponent *caller) {
    ...
    if (code != 63) {
        ...
        snprintf(Buffer, sizeof Buffer, pinball::get_rc_string(137, 0),
                 control_lite56_tag.Component->MessageField);
        control_mission_text_box_tag.Component->Display(Buffer, -1.0);
        return;
    }
...
void control::LaunchTrainingController(int code, TPinballComponent *caller) {
    ...
    if (code != 63) {
        ...
        snprintf(Buffer, sizeof Buffer, pinball::get_rc_string(110, 0),
                 control_lite56_tag.Component->MessageField);
        control_mission_text_box_tag.Component->Display(Buffer, -1.0);
        return;
    }
...
void control::MaelstromController(int code, TPinballComponent *caller) {
    ...
    if (code != 63) {
        ...
        snprintf(Buffer, sizeof Buffer, pinball::get_rc_string(148, 0),
                 control_lite56_tag.Component->MessageField);
        control_mission_text_box_tag.Component->Display(Buffer, -1.0);
        return;
    }
...
void control::MaelstromPartThreeController(int code, TPinballComponent *caller) {
    ...
    if (code != 63) {
        ...
        snprintf(Buffer, sizeof Buffer, pinball::get_rc_string(150, 0),
                 control_lite56_tag.Component->MessageField);
        control_mission_text_box_tag.Component->Display(Buffer, -1.0);
        return;
    }
...
void control::MaelstromPartTwoController(int code, TPinballComponent *caller) {
    ...
    if (code != 63) {
        ...
        snprintf(Buffer, sizeof Buffer, pinball::get_rc_string(149, 0),
                 control_lite56_tag.Component->MessageField);
        control_mission_text_box_tag.Component->Display(Buffer, -1.0);
        return;
    }
...
void control::ReconnaissanceController(int code, TPinballComponent *caller) {
    ...
    if (code != 63) {
        ...
        snprintf(Buffer, sizeof Buffer, pinball::get_rc_string(134, 0),
                 control_lite56_tag.Component->MessageField);
        control_mission_text_box_tag.Component->Display(Buffer, -1.0);
        return;
    }
...
void control::ReentryTrainingController(int code, TPinballComponent *caller) {
    ...
    if (code != 63) {
        if (code == 66) {
            control_lite56_tag.Component->MessageField = 3;
            control_l_trek_lights_tag.Component->Message(20, 0.0);
            static_cast<TPinballComponent *>(control_l_trek_lights_tag.Component)->Message(32,
                                                                                           0.2f);
            static_cast<TPinballComponent *>(control_l_trek_lights_tag.Component)->Message(26,
                                                                                           0.2f);
            control_r_trek_lights_tag.Component->Message(20, 0.0);
            static_cast<TPinballComponent *>(control_r_trek_lights_tag.Component)->Message(32,
                                                                                           0.2f);
            static_cast<TPinballComponent *>(control_r_trek_lights_tag.Component)->Message(26,
                                                                                           0.2f);
            control_lite307_tag.Component->Message(7, 0.0);
        } else if (code != 67) {
            return;
        }
        snprintf(Buffer, sizeof Buffer, pinball::get_rc_string(112, 0),
                 control_lite56_tag.Component->MessageField);
        control_mission_text_box_tag.Component->Display(Buffer, -1.0);
        return;
    }
    ...
    switch (code) {
        ...
        case 67:
            if (light_on(&control_lite20_tag)) {
                control_mission_text_box_tag.Component->Display(pinball::get_rc_string(128, 0),
                                                                -1.0);
                if (light_on(&control_lite303_tag))
                    control_lite303_tag.Component->Message(20, 0.0);
                if (!light_on(&control_lite304_tag)) {
                ...
                control_mission_text_box_tag.Component->Display(pinball::get_rc_string(127, 0),
                                                                -1.0);
                if (light_on(&control_lite304_tag))
                    control_lite304_tag.Component->Message(20, 0.0);
                if (!light_on(&control_lite303_tag)) {
...
void control::SatelliteController(int code, TPinballComponent *caller) {
    ...
    if (code != 63) {
        ...
        snprintf(Buffer, sizeof Buffer, pinball::get_rc_string(132, 0),
                 control_lite56_tag.Component->MessageField);
        control_mission_text_box_tag.Component->Display(Buffer, -1.0);
        return;
    }
...
void control::ScienceMissionController(int code, TPinballComponent *caller) {
    ...
    if (code != 63) {
        ...
        snprintf(Buffer, sizeof Buffer, pinball::get_rc_string(114, 0),
                 control_lite56_tag.Component->MessageField);
        control_mission_text_box_tag.Component->Display(Buffer, -1.0);
        return;
    }
...
void control::StrayCometController(int code, TPinballComponent *caller) {
    ...
    if (code == 63) {
        ...
        } else if (control_kickout2_tag.Component == caller &&
                   control_lite107_tag.Component->MessageField == 15) {
            control_lite304_tag.Component->Message(20, 0.0);
            control_lite198_tag.Component->MessageField = 1;
            MissionControl(66, nullptr);
...
void control::TimeWarpController(int code, TPinballComponent *caller) {
    ...
    if (code != 63) {
        ...
        snprintf(Buffer, sizeof Buffer, pinball::get_rc_string(146, 0),
                 control_lite56_tag.Component->MessageField);
        control_mission_text_box_tag.Component->Display(Buffer, -1.0);
        return;
    }
...
void control::TimeWarpPartTwoController(int code, TPinballComponent *caller) {
    ...
    if (control_kickout2_tag.Component == caller) {
        ...
        if (control_middle_circle_tag.Component->Message(37, 0.0) > 1) {
            ...
            snprintf(Buffer, sizeof Buffer, pinball::get_rc_string(174, 0),
                     pinball::get_rc_string(RankRcArray[rank - 1], 1));
            control_mission_text_box_tag.Component->Display(Buffer, 8.0);
        }
    } else {
        if (control_ramp_tag.Component != caller)
        ...
        if (control_middle_circle_tag.Component->Message(37, 0.0) < 9) {
            ...
            snprintf(Buffer, sizeof Buffer, pinball::get_rc_string(173, 0),
                     pinball::get_rc_string(RankRcArray[rank], 1));
        }
...
void control::WaitingDeploymentController(int code, TPinballComponent *caller) {
    switch (code) {
        case 63:
            if (control_oneway4_tag.Component == caller ||
                control_oneway10_tag.Component == caller) {
                control_lite198_tag.Component->MessageField = 1;
                MissionControl(66, nullptr);
            }
            break;
