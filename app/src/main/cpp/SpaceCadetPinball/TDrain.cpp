...
TDrain::TDrain(TPinballTable *table, int groupIndex) : TCollisionComponent(table, groupIndex,
                                                                           true) {
    Timer = 0;
...
void TDrain::Collision(TBall *ball, vector_type *nextPosition, vector_type *direction, float coef,
                       TEdgeSegment *edge) {
